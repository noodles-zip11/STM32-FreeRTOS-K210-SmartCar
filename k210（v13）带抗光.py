...
BLACK_THRESHOLD = (0, 8, -128, 127, -128, 127)  # fallback
ROIS = (
    (0, 160, 320, 80, 0.55),
    (0, 110, 320, 50, 0.30),
    (0, 70, 320, 40, 0.15),
...
# Anti-light-interference: per-ROI adaptive L-threshold (RGB565 LAB L channel).
...
lost_hold_frames = 0
last_edge_dir = 0
roi_l_mean_f = [None, None, None]
roi_l_thr_dbg = [BLACK_THRESHOLD[1], BLACK_THRESHOLD[1], BLACK_THRESHOLD[1]]
